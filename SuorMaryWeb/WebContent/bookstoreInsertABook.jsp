...
<% List<Author> authors = (List<Author>) request.getAttribute("authors"); %>
	...
	<div class="container">
    	<h1>Add a book</h1>
    	<form action="./bookstoreInsertABook" method="POST">
        <div>
	      ...
	      <select name="author" id="author" required>
	        <% for(Author a: authors) { %>
        		<option value="<%= a.getId() %>"><%= a.getSurname() %></option>
    		<% } %>
	      </select><br>
	      <label for="author"><b>Editor : </b></label><br>
	      ...
	      <input type="number" placeholder="Enter the quantity" name="quantity" id="quantity" required></b>

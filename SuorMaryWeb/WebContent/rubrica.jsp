...
%>
<div style="margin: auto; padding: 20px; text-align: center; background-color: #404040">
	<form>
		<input type="text" name="stringToFind" style="width: 300px;" />
		<input type="submit" name="find" value="Cerca" />
	</form>
</div>
<div style="margin: auto; padding: 20px; background-color: #404040">

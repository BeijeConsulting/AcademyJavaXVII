...
/*
 * La classe Java chiamata RubricaJDBC illustra l'utilizzo di JDBC (Java Database Connectivity) 
 * per connettersi a un database MySQL e recuperare dati da una tabella chiamata "rubrica"
 */

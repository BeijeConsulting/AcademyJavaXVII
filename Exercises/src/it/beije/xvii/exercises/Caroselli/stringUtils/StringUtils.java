...
public class StringUtils {
    ...
    public static int indexOfFromIndexEx(String s, char c, int fromIndex) {
        ...
        for (int i = fromIndex; i < s.length(); i++) {
            ...
            if (fromIndex > index) {
                //System.out.println("L'indice del carattere che vuoi cercare non e' contenuto nella stringa dall'indice : " + fromIndex);
                return -1;
            }
    ...
    public static int indexOfStrFromStr(String str, String s) {
        ...
        for (int i = 0; i <= strLength - sLength; i++) {
            ...
            //per confrontare i caratteri della stringa str a partire dall'indice i con i caratteri di s
